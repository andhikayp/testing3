...
<html lang="en" class="no-focus">
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('img/logo_jatim.png') }}">
        <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('img/logo_jatim.png') }}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('img/logo_jatim.png') }}">
        <!-- END Icons -->
